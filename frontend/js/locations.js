const UZ_LOCATIONS = {
    "Toshkent shahri": [
        ...
        "Olmazor tumani", "Sergeli tumani", "Yakkasaroy tumani", 
        "Yashnobod tumani", "Bektemir tumani", "Shayxontohur tumani", 
        "Uchtepa tumani", "Mirobod tumani", "Yangihayot tumani"
    ],
    "Andijon viloyati": [
    ...
    "Farg'ona viloyati": [
        ...
        "Bog'dod tumani", "Beshariq tumani", "Buvayda tumani", "Dang'ara tumani", 
        "Farg'ona tumani", "Furqat tumani", "Oltiariq tumani", "O'zbekiston tumani", 
        "Quva tumani", "Rishton tumani", "So'x tumani", "Toshloq tumani", 
        "Uchko'prik tumani", "Yozyovon tumani", "Oltiariq tumani"
    ],
    "Jizzax viloyati": [
        "Jizzax shahri", "Arnasoy tumani", "Baxmal tumani", "Do'stlik tumani", 
        "Forish tumani", "G'allaorol tumani", "Sharof Rashidov tumani", "Mirzachul tumani", 
        "Paxtakor tumani", "Yangiobod tumani", "Zafarobod tumani", "Zomin tumani", "Zarbdor tumani"
    ],
    "Xorazm viloyati": [
    ...
    "Navoiy viloyati": [
        ...
        "Uchquduq tumani", "Xatirchi tumani", "G'ozg'on shahri"
    ],
    "Qashqadaryo viloyati": [
        ...
        "Mirishkor tumani", "Muborak tumani", "Nishon tumani", "Qarshi tumani", 
        "Qamashi tumani", "Yakkabog' tumani", "Shahrisabz tumani", "Ko'kdala tumani"
    ],
    "Samarqand viloyati": [
    ...
    "Surxondaryo viloyati": [
        ...
        "Qumqo'rg'on tumani", "Sherobod tumani", "Sho'rchi tumani", "Termiz tumani", 
        "Uzun tumani", "Sariosiyo tumani", "Bandixon tumani"
    ],
    "Toshkent viloyati": [
        "Nurafshon shahri", "Angren shahri", "Bekobod shahri", "Olmaliq shahri", 
        "Chirchiq shahri", "Ohangaron shahri", "Yangiyo'l shahri", "Oqqo'rg'on tumani", 
        "Bo'stonliq tumani", "Bo'ka tumani", "Qibray tumani", "Quyi Chirchiq tumani", 
        "Parkent tumani", "Piskent tumani", "Zangiota tumani", "O'rta Chirchiq tumani", 
        "Chinoz tumani", "Yuqori Chirchiq tumani", "Toshkent tumani", "Yangiyo'l tumani", "Ohangaron tumani"
    ],
    "Qoraqalpog'iston Respublikasi": [
        "Nukus shahri", "Amudaryo tumani", "Beruniy tumani", "Ellikqala tumani", 
        ...
        "To'rtko'l tumani", "Xo'jayli tumani", "Chimboy tumani", "Bo'zatov tumani", "Taxiatosh tumani"
    ]
};
